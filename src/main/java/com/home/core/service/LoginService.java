...
public class LoginService {
	...
	private static final String APPID = "wx0d98d15e1edc058a";
	private static final String SECRET = "02feafd54c4672482e02cf230a9a4ade";
	@Autowired
	...
	public String get3drSessionKey(String code, String name, String img,
		...
		if (responseEntity != null
			...
			if (num <= 0) {
				String geom1 = HmacUtil.stringPoitGEO(geom);
				String[] user1 = { HmacUtil.getUUID(), name, openId, img, geom1 };
